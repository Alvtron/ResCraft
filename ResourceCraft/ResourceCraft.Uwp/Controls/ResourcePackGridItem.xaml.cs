...
{
    public sealed partial class ResourcePackGridItem : UserControl
    {
        public static readonly DependencyProperty ResourcePackProperty = DependencyProperty.Register("ResourcePack", typeof(ResourcePack), typeof(ResourcePackGridItem), new PropertyMetadata(new ResourcePack()));
